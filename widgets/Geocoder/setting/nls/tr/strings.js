define({
    ...
    actions: "İşlemler",
    warning: "Hatalı Servis",
    instruction: "Bu araçta kullanılacak olan coğrafi kodlayıcıları oluşturun. URL başvurusu yapmak, kullanıcı dostu adı belirtmek ve diğer özellikleri ayarlamak için Coğrafi Kodlayıcı Ekle seçeneğine tıklayın. Ayrıca coğrafi kodlayıcılarınızı aşağıda yeniden sıralayabilir, yapılandırabilir veya silebilirsiniz.",
