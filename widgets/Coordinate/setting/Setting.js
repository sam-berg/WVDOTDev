...
define([
  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
        ...
        utils.loadResource().then(lang.hitch(this, function() {
          if (config.spatialReferences && config.spatialReferences.length) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              json.push({
                wkid: this._standardizeWkid(wkid),
      ...
      _addMapCoordinate: function() {
        ...
        portalUtils.getUnits(this.appConfig.portalUrl).then(lang.hitch(this, function(units) {
          if (utils.isValidWkid(mapWkid)) {
            var item = {
              wkid: this._standardizeWkid(mapWkid),
      ...
      _standardizeWkid: function(wkid) {
        return parseInt(wkid, 10) === 102100 ? 3857 : parseInt(wkid, 10);
      },
      ...
      _onEditOk: function() {
        ...
        json.wkid = this._standardizeWkid(json.wkid);
