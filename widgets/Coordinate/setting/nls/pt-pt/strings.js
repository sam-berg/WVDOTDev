define({
    ...
    state: "Por defeito, as coordenadas serão exibidas no sistema de coordenadas do mapa atual. Para obter coordenadas noutros sistemas de coordenadas, necessita de adicionar esse sistema e definir as transformações apropriadas.",
