  ...
  function(
    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function() {
        ...
        this._mapWkid = this.map.spatialReference.wkid === 102100 ?
      ...
      initPopMenu: function(spatialReferences) {
        ...
        if (!lang.isArray(spatialReferences)) {
      ...
      _isWebMercator: function(wkid) {
        return parseInt(wkid, 10) === 102100 || parseInt(wkid, 10) === 3857;
      },
      ...
      onProjectComplete: function(wkid, geometries) {
        ...
        this.coordinateInfo.innerHTML += "  (" + this._unitToNls(outputUnit) + ")";
      },
      ...
      onMouseMove: function(evt) {
        ...
        var specialCase = (this._mapWkid === 4326 && this._isWebMercator(this.selectedWkid)) ||
        ...
        if (specialCase) {
          ...
          } else if (this._isWebMercator(mapPoint.spatialReference.wkid) &&
          ...
          if (options.defaultUnit === outUnit) {
            this.coordinateInfo.innerHTML = "X: " + this._toFormat(x) +
              ",  Y: " + this._toFormat(y);
      ...
      _displayDegOrDms: function(outUnit, y, x) {
        ...
        if ("DEGREE_MINUTE_SECONDS" === outUnit) {
          ...
          this.coordinateInfo.innerHTML = "LON: " + this._toFormat(x) +
            ",  LAT: " + this._toFormat(y);
        }
      },
      ...
      _displayProject: function(outUnit, y, x) {
        ...
        this.coordinateInfo.innerHTML = "X: " + this._toFormat(x) + ",  Y: " + this._toFormat(y);
      },
