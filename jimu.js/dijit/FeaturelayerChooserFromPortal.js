...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template,
  lang, html, array, on, query, Deferred, Evented, promiseAll, ItemSelector, esriRequest) {
      ...
      if(isQuery){
        ...
        var defs = array.map(layers, lang.hitch(this, function(layer){
          ...
          esriRequest({
            ...
            var trStr = '<tr><td><input class="layer-checkbox" type="checkbox" /></td>' +
            '<td><span class="layer-name"></span></td></tr>';
        ...
        this._showLayersErrorInfo(this.nls.notSupportQuery);
      }
    },
