...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    onlyShowPublicOnlineFeaturedItems: true,
    ...
    _initSearchQuery: function(){
      ...
      var strPublicPortalQuery=orgStr+this._itemTypeQueryString+' AND access:public '+ownerStr;

      //portal public
      this._allPublicPortalQuery = this._getQuery({
        sortField:'numViews',
        sortOrder:'desc',
        q: strPublicPortalQuery//this._itemTypeQueryString + ' AND access:public'
      });
      ...
      var strGroup = this.onlyShowPublicOnlineFeaturedItems ? groupIds : ' ';
      this._allPublicOnlineQuery = this._getQuery({
        sortField:'numViews',
        sortOrder:'desc',
        q: strGroup + this._itemTypeQueryString + ' AND access:public'
      });
    ...
    _onPublicSearch: function(text){
      ...
      if(text){
        ...
        if (this.portalPublicRaido.checked) {
          //text + this._itemTypeQueryString + ' AND access:public';
    ...
    _searchOrganization: function(user) {
      ...
      var q = " orgid:" + user.orgId + " AND " + this._itemTypeQueryString + strPublicOrg;
      var portalUrl = this._getPortalUrl();
