...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,
  ...
  FeaturelayerChooserFromPortal, _FeaturelayerServiceChooserContent) {
  ...
  var FeaturelayerChooserWithButtons=declare(baseClassArr,{
    ...
    templateString: '<div>' +
      ...
      '<div class="footer">'+
        ...
        '<div class="jimu-btn ok jimu-state-disabled" data-dojo-attach-point="btnOk">'+
          '${nls.ok}'+
        '</div>'+
      '</div>' +
    '</div>',
  ...
  return declare([_WidgetBase, _TemplatedMixin,_WidgetsInTemplateMixin, Evented], {
    ...
    _createFeaturelayerChooserFromPortal: function(){
      ...
      if(portalUrl.indexOf('.arcgis.com') >= 0){
